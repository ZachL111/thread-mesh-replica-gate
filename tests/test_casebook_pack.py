"""Regression checks for the thread-mesh-replica-gate casebook."""
...
from casebook.harness import assert_expected, thread_mesh_replica_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_mesh_replica_gate_summary(), assert_expected())
